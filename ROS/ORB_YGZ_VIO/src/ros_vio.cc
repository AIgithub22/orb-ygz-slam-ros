...
int main(int argc, char **argv)
{
    ...
    ros::Rate r(1000);
        ...
        while(ros::ok())
        {
            ...
            if(bdata)
            {
                std::vector<ygz::IMUData> vimuData;
                ...
                for(unsigned int i=0;i<vimuMsg.size();i++)
                {
                    ...
                    ygz::IMUData imudata(imuMsg->angular_velocity.x,imuMsg->angular_velocity.y,imuMsg->angular_velocity.z,
